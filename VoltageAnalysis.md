...
<img src="./Voltage_Analysis/U_RotorDeviated.svg" width="200" />


When the stator is inclined, there could be no significant variiation of the effective value be observed. [Link](./Voltage_Analysis/StatorInclination_URMS_nconst.ipynb) to the notebook.

<img src="./Voltage_Analysis/U_StatorInclination.svg" width="200" />